document.addEventListener('DOMContentLoaded', () => {
  // Initializare produse daca nu exista in localStorage
  ...
  // Functie generala pentru a randa produse intr-un container
  ...
  // Expunem functii globale
  window.addToCart = addToCart;
  window.renderProducts = renderProducts;

  // Render automat pentru products.html
